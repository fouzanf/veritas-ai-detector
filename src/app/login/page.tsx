...
export default function LoginPage() {
  ...
  return (
    <div className="flex-1 flex items-center justify-center p-6 relative overflow-hidden perspective-1000 min-h-screen">
      <LoginBackground />
          ...
          <Card className="relative bg-black/40 backdrop-blur-[20px] border-white/10 shadow-2xl rounded-[2.5rem] overflow-hidden preserve-3d">
            ...
            <CardContent className="grid gap-8 pt-8 pb-12 translate-z-20 px-8">
              <div className="space-y-6">
                {/* Inputs and divider removed - only Google button and social proof remain */}
                <Button
                  variant="outline"
